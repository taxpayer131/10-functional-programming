...
// SCOTT WILL COVER LATER: Wrap the contents of this file, except for the preceding 'use strict' and 'var app...' declararions, in an IIFE.
...
articleView.initAdminPage = function() {
  ...
  //compiles template data from all text content contained within admin-handlebars elements including children.
  let handlebarTemp = Handlebars.compile($('#admin-handlebars').text());
  ...
  app.Article.numWordsByAuthor().forEach(stat => $('.author-stats').append(handlebarTemp(stat)));
